...
class GillyClient(discord.Client):
    def __init__(self, *args, **kwargs):
        ...
        self.discord_channel = True
        self.discord_channel = True
        self.discord_to_discord_channel = True
    ...
    async def send_embed_from_vk(self, post, group_profile):
        ...
        sent = await self.discord_channel.send(embed=embed)
    ...
    async def on_ready(self):
        ...
        self.discord_channel = self.get_channel(config.discord_channel_id)
